package cl.ejercicio.ntt.services;
...
import cl.ejercicio.ntt.repository.UserManagementRepository;
import cl.ejercicio.ntt.service.impl.UserManagementServiceImpl;
import cl.ejercicio.ntt.utils.Constants;
import cl.ejercicio.ntt.utils.JwtUtil;
...
class UserManagementServiceTest {
    ...
    void addUser_success_shouldReturnResponse() {
        ...
        when(mapperHelper.mapToGenericResponse(any())).thenReturn(new GenericResponseDTO());

        GenericResponseDTO response = service.addUser(userRequestDTO);
