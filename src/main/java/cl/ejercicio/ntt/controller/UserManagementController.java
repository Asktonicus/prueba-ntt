package cl.ejercicio.ntt.controller;
...
import cl.ejercicio.ntt.service.UserManagementService;
...
public class UserManagementController {
    ...
    public ResponseEntity<?> addUser(@Valid @RequestBody UserRequestDTO dto) {
        try {
            GenericResponseDTO response = userManagementService.addUser(dto);
    ...
    public UserResponseDTO updateUser(
            ...
            @RequestBody UserRequestDTO requestDTO) throws JsonProcessingException {
